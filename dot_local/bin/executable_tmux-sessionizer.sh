...
if [[ $# -eq 1 ]]; then
    ...
    selected=$(find ~/Documents/Code ~/Documents/Code/college ~/Documents/Code/PicCollage ~/Documents/Code/other ~/Documents/Code/web -mindepth 1 -maxdepth 1 -type d | fzf)
fi
